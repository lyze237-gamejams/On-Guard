...
public class GameUi extends Stage {
    ...
    public GameUi(Game game) {
        ...
        table.add(new UnitButton(SnakeUnit.class, game, "Buttons/Snake/Snake_Button_Up", "Buttons/Snake/Snake_Button_Down")).padTop(1).row();
        table.add(new UnitButton(GuardUnit.class, game, "Buttons/Guard/Guard_Button_Up", "Buttons/Guard/Guard_Button_Down")).padTop(1).row();
        table.add(new UnitButton(MageUnit.class, game, "Buttons/Mage/Mage_Button_Up", "Buttons/Mage/Mage_Button_Down")).padTop(1).row();
        table.add(new UnitButton(SamuraiUnit.class, game, "Buttons/Samurai/Samurai_Button_Up", "Buttons/Samurai/Samurai_Button_Down")).padTop(1).row();
